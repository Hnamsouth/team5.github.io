...
var s = document.getElementsByClassName('meo');
// console.log(s)
var img = [-110, 0, 110, 220];
var deg = [0, 90, 180, 360];
var img2 = [-110, 0, 110];


function btnright() {
    console.log(s[2].getAttribute('style'))
    for (let i = 0; i < 4; i++) {
        // console.log(s[i].getAttribute('style'))
        // console.log(s[i]);
        if (img[3] > 0) {
            s[i].style.transform = `translateX(${img[i]-110}%)`;
            img[i] -= 110;
        }
    }
}
